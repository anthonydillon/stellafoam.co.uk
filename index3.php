...
<head>
	...
	<link rel="stylesheet" type="text/css" href="rebrand.css" media="all" />
    <?php
	...
	<div id="pageWrapper">
        ...
        <div id="content">
			...
			<div class="new-promo">
            	...
            	<img src="/images/homepage/VO.jpg" class="full" border="0" />
            </div>

            <a href="/door-range.php" title="Made To Measure">
            <div class="new-promo">
            	<h2>MADE TO MEASURE DOOR SERVICE</h2>
            	<img src="/images/homepage/door-service-promo.jpg" class="full" border="0" />
            </div>
            </a>
			...
			<div class="new-promo clicbox-promo">
            ...
            <div class="new-promo last-promo workshop-promo">
            	<h2>HIRE OUR WORKSHOP!</h2>
            	<img src="/images/homepage/workshop.jpg" border="0" />
            </div>
            </a>

			<p><a href="https://www.facebook.com/pages/Stellafoam/279797505497874" class="facebook"><img src="facebook-icon.png" alt="" style="vertical-align:middle; margin-right: 4px;" width="30" height="30" border="0" /> Find us on Facebook</a></p>
		</div>
        <?php
			include  'footer.php';
    	?>
